...
import DcmAssignmentCard from '../../components/cards/DcmAssignmentCard';
              ...
              <div className="p-4">
                <CardGridView
                  ...
                  renderCard={(item) => (
                    <DcmAssignmentCard
                      item={item}
                      onAssign={(i) => setEditing(i)}
                      onRowClick={(i) => setEditing(i)}
                    />
                  )}
                  empty={<div className="p-8 text-center text-slate-500">No assignment records found.</div>}
                />
              </div>
            ) : (
