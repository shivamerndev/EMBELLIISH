...
const NAV = [
    ...
    children: [
      {
        ...
        children: [
          ...
          { label: 'Reassign DCM', path: '/crm/delayed-leads' },
        ],
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Design Finalisation", path: "/pms/design-finalisation" },
      { label: "Execution Drawing Request Raise", path: "/pms/execution-drawing-request" },
      { label: "Execution Drawing Preparation", path: "/pms/execution-drawing-preparation" },
      { label: "Approvals", path: "/pms/approvals" },
      { label: "Change / Revision Control ", path: "/pms/change-revision-control" },
      { label: "Order Sheet / FMS Creation", path: "/pms/order-sheet-fms-creation" },
      { label: "Procurement Request", path: "/pms/procurement-request" },
      { label: "Motors / Accessories Control", path: "/pms/motors-accessories-control" },
      { label: "Production / QC Status", path: "/pms/qc-status" },
      { label: "Packing / Dispatch Readiness", path: "/pms/packing-dispatch-readiness" },
      { label: "Installation", path: "/pms/installation" },
      { label: "Final Payment", path: "/pms/final-payment" },
      { label: "Installation Scheduling", path: "/pms/installation-scheduling" },
      { label: "Installation Brief / Dispatch to Site", path: "/pms/installation-brief-dispatch" },
